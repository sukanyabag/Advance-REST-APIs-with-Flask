...
#a large generic error handler which does same as 
# 'except ValidationError as err'
#Note-
#schema.load() raises a ValidationError error when invalid data are passed in. 
# to access the dictionary of val errors use ValidationError.messages attr. 
def handle_marshmallow_validations(err):
...
api.add_resource(Confirmation, "/user_confirmation/<string:confirmation_id>") # for confirmation html page
api.add_resource(ConfirmationByUser, "/confirmation/user/<int:user_id>") # for retrieving/resending confirmations

if __name__ == "__main__":
  #init_app callback is used to initialize an app for the use with this database setup
  db.init_app(app)
  #tells marshmallow what flask app it should be talking to
  #note - sqlalchemy models can directly communicate with flask_marshmallow
